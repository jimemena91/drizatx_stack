...
function InputOTPSlot({
  ...
  return (
    <div
      ...
      className={cn(
        // layout + shape (slots unidos)
        "relative flex h-9 w-9 items-center justify-center border-y border-r first:border-l first:rounded-l-md last:rounded-r-md",
        // palette + states
        "bg-input-background dark:bg-input/30 border-input text-sm transition-all outline-none",
