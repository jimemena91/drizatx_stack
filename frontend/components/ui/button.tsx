  ...
  ].join(" "),
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border bg-background hover:bg-muted/50 hover:text-foreground dark:bg-transparent",
        secondary:
        ...
        link:
          "text-primary underline-offset-4 hover:underline bg-transparent shadow-none",
      },
      size: {
