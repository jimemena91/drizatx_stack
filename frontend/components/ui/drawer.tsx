...
function DrawerOverlay({
  ...
  return (
    <DrawerPrimitive.Overlay
      ...
      className={cn(
        // Animaciones + overlay consistente con el resto de modales
    ...
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          ...
          "bg-card text-card-foreground border-border/60 shadow-lg",
          // Borde y ring accesible cuando hay foco dentro
        ...
        {...props}
      >
        {/* Asa/Grabber visible solo en drawer inferior */}
  ...
  return (
    <div
      ...
      className={cn(
        ...
        // Centrado en top/bottom; left/right queda como esté
