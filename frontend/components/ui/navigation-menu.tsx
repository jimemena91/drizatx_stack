  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        ...
        // modo sin viewport (el contenedor hace de popover)
        ...
        "group-data-[viewport=false]/navigation-menu:overflow-hidden group-data-[viewport=false]/navigation-menu:rounded-md group-data-[viewport=false]/navigation-menu:border group-data-[viewport=false]/navigation-menu:shadow group-data-[viewport=false]/navigation-menu:duration-200",
        // evitar doble focus-ring dentro
    ...
    <div className="absolute top-full left-0 isolate z-50 flex justify-center">
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          ...
          "origin-top-center overflow-hidden rounded-md border bg-popover text-popover-foreground shadow",
