  ...
  return (
    <ResizablePrimitive.PanelResizeHandle
      ...
      className={cn(
        ...
        // Área “grande” de interacción invisible para mejor UX
        ...
        // Focus visible coherente con la paleta
        "focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-1",
        // Rota el “handle” cuando el grupo es vertical
    ...
    >
      {withHandle && (
        <div className="z-10 flex h-4 w-3 items-center justify-center rounded-xs border bg-muted border-border">
